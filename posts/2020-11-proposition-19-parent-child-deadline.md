...
If your only property is a home that is assessed at under $1 million that your child will live in after you die, then your house qualifies as a “family home” under Proposition 19, and you have nothing to worry about. But if you do have other property, then the only way to avoid Proposition 19’s new changes is to act fast before it applies.

There are typically two types of taxes to consider for parent-child transfers: the property tax (typically about 1.2% per year) and the federal and state capital gains tax (15% or 20% federally, and the ordinary income bracket for state taxes of typically around 10%). Once the parent gives the child a property, if the child wants to hold onto the property indefinitely, then the property taxes are more important and the capital gains taxes are irrelevant. If the child wants to sell the property right away, then the capital gains taxes will be more important and his property tax assessment will be irrelevant.

If the child will sell the property after inheritance, then you may just want to put the child in the will or trust like normal. This is advantageous because the federal capital gains step-up in basis requires you to transfer the property upon death, not earlier ([26 USC §1014](https://www.law.cornell.edu/uscode/text/26/1014), [IRS Publication 551](https://www.irs.gov/publications/p551#idm140486307579360)). The child’s property tax will go up due to Proposition 19 when he inherits a property other than a family home, but it doesn’t matter if he sells the property. If the step-up basis still exists at the time of death, then the child will sell the house and pay no capital gains taxes. But be warned that President-Elect Biden has promised to eliminate the stepped-up basis ([Matthew Yglesias (Dec. 5, 2019), Joe Biden’s plan to raise taxes on corporations and the rich, explained](https://www.vox.com/policy-and-politics/2019/12/5/20995225/joe-biden-tax-plan)).
...
A child who inherits a family home is still allowed to move out and rent out the house later. Unlike the [SCA 3](http://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=201920200SCA3) proposal, there is no requirement that the child live in the house he inherited continuously. However, if the child moves in only for the exclusion from change in ownership and then moves out right away, then the assessor may combine the suspicious steps into a single step under the “step transaction doctrine” and reappraise the property.

You can still transfer a principal residence to your child multiple times in your life, so you can transfer one house to a child, move into another house, and transfer that one to a child too. But you can’t plan to move into each property solely for tax purposes, or else the assessor may combine the suspicious steps into a single step under the “step transaction doctrine” and reappraise one or both of the houses.

You can still use tax portability to change the percentage ownerships with a third party, so you can sell your old house and buy a new house with someone else as co-owner to partially transfer the low assessment to them.
